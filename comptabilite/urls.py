...
router.register(r'plan-comptable', PlanComptableViewset,
                basename='plan-comptable')
...
router.register(r'factures-comptables', FactureComptableViewset,
                basename='facture-comptable')
